...
HWND WINAPI CreateButton3(  //up scale
	HWND hwndDlg,  // handle of dialog box (parent window) 
	UINT XPOS,    // x position
	UINT YPOS,    // y position
	UINT XSIZE,   // x size
...
HWND WINAPI CreateButton4(  //down scale
	HWND hwndDlg,  // handle of dialog box (parent window) 
	UINT XPOS,    // x position
	UINT YPOS,    // y position
	UINT XSIZE,   // x size
...
LRESULT CALLBACK windowprocessforwindow3(HWND handleforwindow3, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	*/
	...
	case WM_CREATE:
	{
		...
		CreateButton2(handleforwindow3, 20, 530, 160, 50);

		//buttons for calibration
		CreateButton3(handleforwindow3, 10, 10, 500, 500);  //scale up
		CreateButton4(handleforwindow3, 10, 475, 160, 50);  //scale down
		CreateButton5(handleforwindow3, 10, 475, 160, 50);  //offset left
		CreateButton6(handleforwindow3, 10, 475, 160, 50);  //offset right
		CreateButton7(handleforwindow3, 10, 475, 160, 50);  //offset up
		CreateButton8(handleforwindow3, 10, 475, 160, 50);  //offset down
